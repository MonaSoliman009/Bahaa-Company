(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboard-dashboard-module"], {
    ...
    /***/
    function ghS(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function tTL(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function o8Ft(module, __webpack_exports__, __webpack_require__) {
      ...
      "CHqn"); // import { NgxSpinnerService } from 'ngx-spinner';


      var DashboardComponent = /*#__PURE__*/function () {
        function DashboardComponent( // private spinner: NgxSpinnerService,
        ...
        _createClass(DashboardComponent, [{
          ...
          value: function alertWithFail() {
            sweetalert2_dist_sweetalert2_js__WEBPACK_IMPORTED_MODULE_4___default.a.fire('Failed', 'Try Again Later', 'error').then(function (res) {
              location.reload();
            });
          } //  showSpinner() {
          //   this.spinner.show();
          ...
          value: function ngOnInit() {
            ...
            this._EmployeeService.getUsersCount().subscribe(function (res) {
              _this.nameOfUser = res;
              console.log(res);
            }, function (error) {});

            this._EmployeeService.getProductsCount().subscribe(function (res) {
              _this.numOfProducts = res;
            }, function (error) {});

            this._EmployeeService.getTestsCount().subscribe(function (res) {
              _this.numOfTests = res;
            }, function (error) {});

            this._EmployeeService.getMaintainedCount().subscribe(function (res) {
              _this.numOfMaintained = res;
            }, function (error) {});

            this._ProductService.getLastFiveProducts().subscribe(function (res) {
              _this.lastFiveProducts = res;
            });
          }
        }]);
    ...
    function pBKm(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_ng_zoro_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! src/app/ng-zoro.module */
      "LkBz"); // import { NgxSpinnerModule } from 'ngx-spinner';
      ...
      DashboardModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_3__["DashboardRoutingModule"], src_app_ng_zoro_module__WEBPACK_IMPORTED_MODULE_5__["DemoNgZorroAntdModule"]]
      })], DashboardModule);
      /***/
    }
  }]);
